// Generated from Content/Data/UnrealImport/Tokyo/Materials/MI_StreetTrim_DarkGray_0a94293e.mat
// Domain: Surface
...
FMaterialEvalResult EvaluateMaterialWithRefraction(FMaterialPixelInput Input)
{
    ...
    float3 n_22 = float3(0.395833f, 0.395833f, 0.395833f);
    ...
    float n_56 = 0.700000f;
    float n_58 = ((n_46).g * n_56);
    float4 n_68 = Tex_Emissive.Sample(LinearWrapSampler, Input.UV0);
    float3 n_78 = float3(0.000000f, 0.000000f, 0.000000f);
    float3 n_80 = ((n_68).rgb * n_78);
    FMaterialResult Result;
    Result.BaseColor = n_24;
    Result.Normal = (n_33).rgb;
    Result.Roughness = (n_46).r;
    Result.Metallic = n_58;
    Result.Emissive = n_80;
    Result.Opacity = 1.0f;
