// Generated from Content/Data/UnrealImport/Tokyo/Materials/MI_UtilityTrim_Gray_bf3d01ea.mat
// Domain: Surface
...
FMaterialEvalResult EvaluateMaterialWithRefraction(FMaterialPixelInput Input)
{
    ...
    float3 n_22 = float3(0.291667f, 0.291667f, 0.291667f);
    ...
    float4 n_60 = Tex_Emissive.Sample(LinearWrapSampler, Input.UV0);
    float3 n_70 = float3(0.000000f, 0.000000f, 0.000000f);
    float3 n_72 = ((n_60).rgb * n_70);
    FMaterialResult Result;
    Result.BaseColor = n_24;
    Result.Normal = (n_33).rgb;
    Result.Roughness = (n_46).r;
    Result.Metallic = (n_46).g;
    Result.Emissive = n_72;
    Result.Opacity = 1.0f;
