// Generated from Content/Data/UnrealImport/Tokyo/Materials/MI_RoadBarriers_BlueEmissive_4dd5df1a.mat
// Domain: Surface
...
FMaterialEvalResult EvaluateMaterialWithRefraction(FMaterialPixelInput Input)
{
    ...
    float4 n_52 = Tex_Emissive.Sample(LinearWrapSampler, Input.UV0);
    float3 n_62 = float3(0.000000f, 2.890680f, 10.000000f);
    float3 n_64 = ((n_52).rgb * n_62);
    FMaterialResult Result;
    Result.BaseColor = (n_12).rgb;
    Result.Normal = (n_25).rgb;
    Result.Roughness = (n_38).r;
    Result.Metallic = (n_38).g;
    Result.Emissive = n_64;
    Result.Opacity = 1.0f;
