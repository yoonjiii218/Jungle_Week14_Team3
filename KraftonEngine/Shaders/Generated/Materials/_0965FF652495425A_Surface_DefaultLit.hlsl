// Generated from Content/Data/UnrealImport/Tokyo/Materials/MI_Panel02_Metallic_Green_aa2d3048.mat
// Domain: Surface
...
FMaterialEvalResult EvaluateMaterialWithRefraction(FMaterialPixelInput Input)
{
    ...
    float3 n_22 = float3(0.252097f, 0.614583f, 0.220866f);
    ...
    float n_56 = 1.200000f;
    float n_58 = ((n_46).r * n_56);
    float n_64 = 3.000000f;
